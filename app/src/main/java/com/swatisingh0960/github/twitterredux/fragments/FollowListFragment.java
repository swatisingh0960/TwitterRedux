...
import com.swatisingh0960.github.twitterredux.activities.ProfileActivity;
...
public class FollowListFragment extends TweetsListFragment {
    ...
    public static FollowListFragment newInstance(User account) {
        FollowListFragment fg = new FollowListFragment();
    ...
    public void populateIdList() {
        TwitterApplication.getRestClient().getFollowersList(account, new JsonHttpResponseHandler(){
            // SUCCESS
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject jsonObject) {
                if (jsonObject != null) {
                    ...
                    try {
                        ...
                        Log.i("DEBUG", "follower list: " + jsonIds.toString());
                        // Populate new users
                        populateUsersList();
