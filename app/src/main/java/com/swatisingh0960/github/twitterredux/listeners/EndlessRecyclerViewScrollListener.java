package com.swatisingh0960.github.twitterredux.listeners;
...
import com.swatisingh0960.github.twitterredux.adapters.MediaContactsAdapter;
...
public abstract class EndlessRecyclerViewScrollListener extends RecyclerView.OnScrollListener {
    ...
    private void updatePosition(int position) {
        if (rvAdapter instanceof ContactsAdapter) {
            ((ContactsAdapter) rvAdapter).update(position);
        } else if (rvAdapter instanceof MediaContactsAdapter){
            ((MediaContactsAdapter) rvAdapter).update(position);
        }
    }
