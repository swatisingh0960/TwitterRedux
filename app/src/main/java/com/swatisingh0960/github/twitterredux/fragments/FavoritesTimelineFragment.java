...
public class FavoritesTimelineFragment extends TweetsListFragment
    ...
    public static FavoritesTimelineFragment newInstance(User account) {
        FavoritesTimelineFragment fg = new FavoritesTimelineFragment();
    ...
    public void populateTimeline(Long since, Long max) {
        TwitterApplication.getRestClient().getFavoritesTimeline(account.getUid(), since, max, new JsonHttpResponseHandler(){
            // SUCCESS
            @Override
            ...
            public void onFailure(int statusCode, Header[] headers, Throwable throwable,
                ...
                Log.d("DEBUG", "Fetch favorites list error: " + errorResponse.toString());
            }
        });
    }
}
